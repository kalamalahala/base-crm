...
?>
<div class="modal fade" id="modal-call-lead" tabindex="-1" role="dialog" aria-labelledby="call-lead-title" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="" id="call-lead-form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="call-lead-submit">Finish Call & Create Calendar Invite</button>
                </div>
